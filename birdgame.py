...
bluejay = ImageTk.PhotoImage(file="bluejay.gif")
...
birds = [bluejay,canary,cardinal,chicken,dove,eagle,flamingo,mockingbird,owl,pheasant,pigeon,raven,robin,sparrow,tucan]
birdimg = random.choice(birds)
computer_guess = str(birds.index(birdimg)+1)
